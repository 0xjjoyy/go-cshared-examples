...
extern "C" {
    pub fn Cosine(p0: GoFloat64) -> GoFloat64;
}
extern "C" {
    pub fn Sort(p0: GoSlice);
}
extern "C" {
    pub fn SortPtr(p0: *mut GoSlice);
}
extern "C" {
    pub fn Log(p0: GoString) -> GoInt;
}
extern "C" {
    pub fn LogPtr(p0: *mut GoString) -> GoInt;
}
